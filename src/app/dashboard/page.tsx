            ...
            <CardContent>
              <div className="text-sm text-gray-600">
                {stats.permissions === 0 && stats.roles === 0 ? (
                  <p>
                    No activity yet. Start by creating your first permission or
                    role!
                  </p>
                ) : (
                  <div className="space-y-2">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                      {stats.permissions > 0 && (
                        <li>{stats.permissions} permissions created</li>
                      )}
                      {stats.roles > 0 && <li>{stats.roles} roles defined</li>}
                      {stats.rolePermissions > 0 && (
                        <li>
                          {stats.rolePermissions} role-permission links
                          established
                        </li>
                      )}
                    </ul>
